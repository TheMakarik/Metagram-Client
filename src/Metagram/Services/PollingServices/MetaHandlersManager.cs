...
public sealed class MetaHandlersManager : IHandlersManager
{
    public HandlerDescriptorList this[UpdateType updateType] => throw new NotImplementedException();

    public IEnumerable<UpdateType> AllowedTypes => throw new NotImplementedException();

    public IEnumerable<UpdateType> Keys => throw new NotImplementedException();
